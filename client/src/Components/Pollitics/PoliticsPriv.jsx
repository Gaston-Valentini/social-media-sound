...
export default function PoliticsPriv(){
    return(
              ...
              <Link to="/"><button>Volver</button></Link>
                <div className={styles.text}>
                    ...
                    <ul>
                        ...
                        <li>La Ley Orgánica 3/2018 de 5 de diciembre (LOPDGDD).</li>
                    </ul></p>
                    <div>

                   
                        <h3>Identidad del responsable del tratamiento de los datos personales </h3>
                       <p> El responsable del tratamiento de los datos personales recogidos en https://socialmediasound.com/ es MIWSIC S.L., provista de NIF: B16745044 (en adelante, Responsable del tratamiento). Sus datos de contacto son los siguientes: Email de contacto: admin@miwsic.com.</p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p>Las categorías de datos que se tratan en https://socialmediasound.com/ son únicamente datos identificativos. En ningún caso, se tratan categorías especiales de datos personales en el sentido del artículo 9 del RGPD. </p>
                    </div>
                    <div>

                        <h3>Base legal para el tratamiento de los datos personales </h3>

                        <p>La base legal para el tratamiento de los datos personales es el consentimiento. https://socialmediasound.com/ se compromete a recabar el consentimiento expreso y verificable del Usuario para el tratamiento de sus datos personales para uno o varios fines específicos. </p>
                        ...
                        <p>Los datos personales son recabados y gestionados por https://socialmediasound.com/ con la finalidad de poder facilitar, agilizar y cumplir los compromisos establecidos entre el Sitio Web y el Usuario o el mantenimiento de la relación que se establezca en los formularios que este último rellene o para atender una solicitud o consulta. </p>

                        <p>Igualmente, los datos podrán ser utilizados con una finalidad comercial de personalización, operativa y estadística, y actividades propias del objeto social de https://socialmediasound.com/, así como para la extracción, almacenamiento de datos y estudios de marketing para adecuar el Contenido ofertado al Usuario, así como mejorar la calidad, funcionamiento y navegación por el Sitio Web. </p>
                    ...
                    <div>
                        ...
                        <p>Los datos personales solo serán retenidos durante el tiempo mínimo necesario para los fines de su tratamiento y, en todo caso, únicamente durante el siguiente plazo: El tiempo necesario para cumplir con las actividades contratadas, o hasta que el Usuario solicite su supresión. 
                    ...
                    <div>
                        ...
                        <p>Sin embargo, debido a que https://socialmediasound.com/ no puede garantizar la inexpugnabilidad de internet ni la ausencia total de hackers u otros que accedan de modo fraudulento a los datos personales, el Responsable del tratamiento se compromete a comunicar al Usuario sin dilación indebida cuando ocurra una violación de la seguridad de los datos personales que sea probable que entrañe un alto riesgo para los derechos y libertades de las personas físicas. Siguiendo lo establecido en el artículo 4 del RGPD, se entiende por violación de la seguridad de los datos personales toda violación de la seguridad que ocasione la destrucción, pérdida o alteración accidental o ilícita de datos personales transmitidos, conservados o tratados de otra forma, o la comunicación o acceso no autorizados a dichos datos. </p>
                    ...
                    <div>
                        ...
                        <p>El Usuario tiene sobre https://socialmediasound.com/ y podrá, por tanto, ejercer frente al responsable del tratamiento los siguientes derechos reconocidos en el RGPD: 
                        <ul>
                        <li>Derecho de acceso: Es el derecho del Usuario a obtener confirmación de https://socialmediasound.com/está tratando o no sus datos personales y, en caso afirmativo, obtener información sobre sus datos concretos de carácter personal y del tratamiento que https://socialmediasound.com/ haya realizado o realice, así como, entre otra, de la información disponible sobre el origen de dichos datos y los destinatarios de las comunicaciones realizadas o previstas de los mismos.</li>
                        ...
                        <li>Derecho de oposición: Es el derecho del Usuario a que no se lleve a cabo el tratamiento de sus datos de carácter personal o se cese el tratamiento de los mismos por parte de https://socialmediasound.com/</li>
                        <li>Derecho a no ser a no ser objeto de una decisión basada únicamente en el tratamiento automatizado, incluida la elaboración de perfiles: Es el derecho del Usuario a no ser objeto de una decisión individualizada basada únicamente en el tratamiento automatizado de sus datos personales, incluida la elaboración de perfiles, existente salvo que la legislación vigente establezca lo contrario. Así pues, el Usuario podrá ejercitar sus derechos mediante comunicación escrita dirigida al Responsable del tratamiento con la referencia “RGPD -https://socialmediasound.com/“, especificando: </li>
                        ...
                        Todo documento que acredite la petición que formula. Esta solicitud y todo otro documento adjunto podrá enviarse a la siguiente dirección de correo electrónico: admin@miwsic.com
                        </p>
                        </div>
